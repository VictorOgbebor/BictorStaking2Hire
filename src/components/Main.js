            ...
            <div className="row">
              <main role="main" className="col-lg-12 d-flex text-center">
                <div className="content mr-auto ml-auto">
                  <h1>Earn <b className="text-danger">~100% APY</b> by hiring Victor Ogbebor</h1>
                  <br></br>
                  <h3>Hiring Closes at:</h3>
                  <h3><DateCountdown dateTo='May 15, 2021 00:00:00 GMT+01:00' callback={()=>alert('Time for staking is over!')} /></h3>
                  <br></br>
                  <br></br>
                  <br></br>
                  <br></br>
                  ...
                  { this.packsAmount() === 0 || this.packsAmount() === 1
                    ? <h3>Currently have <b>{this.packsAmount()}</b> pack of 32 offers</h3>
                    : <h3>Currently have <b>{this.packsAmount()}</b> pack of 32 offers</h3>
                  }
                  <br></br>
                  ...
                  >
                  { this.props.account
                    ? <Button variant="success" size="lg" onClick={this.openModal}><h1>HIRE N0W!</h1></Button>
